...
5. `animated_human_SMPL_to_USD` used to convert SMPL animated sequences in USD files
6. `Front3D_to_USD` used to convert FRONT-3D to USD files. Based on BlenderProc.
